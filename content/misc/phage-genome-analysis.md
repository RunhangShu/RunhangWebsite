### Bacteria-phage genome analysis : A case study from a published paper
...
### Paper title: [Rampant prophage movement among transient competitors drives rapid adaptation during infection](https://www.science.org/doi/10.1126/sciadv.abh1489)
...
<div id='id-section1'/>    
## Table of content
* [Download sequence data in NCBI](#id-section1)
* [Quality check, filtering, trimming](#id-section2)
* [De novo assemble the short-reads using SPAdes](#id-section3)
* [Mutation calling using Breseq](#id-section4)
* [Mobile elements detection using MGEFinder](#id-section5)
